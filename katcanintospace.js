...
if (typeof ignoretop === 'undefined' || !ignoretop) {
    ...
    document.body.insertAdjacentHTML("afterbegin", "<style>#topmessage {  position: fixed !important;top: 0 !important;left: 0 !important;width: 100% !important;background: linear-gradient(45deg, orange, darkorange) !important;color: white !important;text-align: center !important;padding: 0px !important;z-index: 999 !important;font-size: 20px !important;}</style><div class='scrolldiv' id='topmessage'><div class='scrolltext' style=\"font-size: 20px !important; font-family: 'Comic Sans MS' !important;\" id='topbannerad' >Happy late new year! Wish you all the best in 2026. B.O.A.T. the G.O.A.T. is delayed, while other projects suffer from short-term stagnation as well. Please refer to the following pages for more information: <a href='/kat/' class='sigmahover1 grab'>/kat/ page</a>, <a href='/kat/lore/' class='sigmahover1 grab'>/kat/lore/ page</a>, <a href='/newz/' class='sigmahover1 grab'>/newz/ page</a>, <a href='/kat/wiki/' class='sigmahover1 grab'>/kat/wiki/ page</a>. Thank you and have a great day! :)</div></div>");
}
