...
window.onload = function () { // Example event date
    ...
    document.body.insertAdjacentHTML("afterbegin", "<style>#topmessage {  position: fixed !important;  top: 0 !important;  left: 0 !important;  width: 100% !important;  background: red !important;  color: white !important;  text-align: center !important;  padding: 0px !important;  z-index: 999999 !important;  font-size: 20px !important;}</style><div class='scrolldiv' id='topmessage'><div class='scrolltext'>!! aTTENTION !! the katdustries building has been breached by 9 masked mates with baloons, the perpetuautors are unknown. pls contact the po po if you have information. BREAKING NEWS! KATS CURRENCY EXCHANGE CRASHES, KATS VALUE TO SC DROPS BY 98% IN THE LAST FIVE DAYS.</div></div><br><div class='scrolldiv' id='topmessage' style='background: blue !important;'><div class='scrolltext'>only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. only sigmas may read this. </div></div>");
    console.log("started")
    //if (page === "index.html") {
