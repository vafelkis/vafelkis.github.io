...
if (typeof ignoretop === 'undefined' || !ignoretop) {
    ...
    document.body.insertAdjacentHTML("afterbegin", "<style>#topmessage {  position: fixed !important;top: 0 !important;left: 0 !important;width: 100% !important;background: linear-gradient(45deg, red, darkred) !important;color: white !important;text-align: center !important;padding: 0px !important;z-index: 999 !important;font-size: 20px !important;}</style><div class='scrolldiv' id='topmessage'><div class='scrolltext' style=\"font-size: 20px !important; font-family: 'Comic Sans MS' !important;\" id='topbannerad' >Merry late Christmas! :) Please note, that this website will likely be left alone for a while. Please check the <a href='/kat/wiki/' class='sigmahover1 grab'>wiki page</a>, the <a href='/kat/lore/' class='sigmahover1 grab'>lore page</a>, the <a href='/newz/' class='sigmahover1 grab'>newz page</a> for more information. E-mail replies will be limited likely as well. Happy new Years, and best of wishes to all of those reading. 💗</div></div>");
}
