...
document.body.insertAdjacentHTML("afterbegin", '<div id="scrollthing" style="position: fixed; top: 0;right: 0;width: 2vh;height: 100vh;background: rgba(255, 255, 255, 0.199); margin: 0;padding: 0;box-sizing: border-box; z-index: 9999;"><div id="scrollamt" style="background: linear-gradient(45deg, rgba(255,179,186,0.8), rgba(255,223,186,0.8), rgba(255,255,186,0.8), rgba(186,255,201,0.8), rgba(186,225,255,0.8), rgba(201,186,255,0.8), rgba(255,186,255,0.8)); outline: 2px rgba(255, 255, 255, 0.57) solid; outline-offset:-2px; background-size: cover; opacity: 1; width:100%; height: 0;"></div><div style="position:absolute; transform: rotate(90deg); font-size:2vh; left: 1.1vh; transform-origin: center left; pointer-events: none; white-space: nowrap; ">hi, imagine not being able to raed this... WAIT. DONT SCROLL!</div></div>')
